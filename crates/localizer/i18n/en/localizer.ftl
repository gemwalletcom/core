...
notification_perpetual_long_title = 📈 {$direction} {$coin}
notification_perpetual_open_description = {$amount} at {$price}
notification_perpetual_short_title = 📉 {$direction} {$coin}
notification_perpetual_close_description = PnL: {$pnl} at {$price}
