...
notification_reward_create_username_description = 用户名已准备就绪。邀请好友即可获得更高奖励。
notification_reward_invite_description = 您的推荐成功了！一位朋友使用您的邀请码加入了我们。
notification_rewards_joined_description = 您通过推荐码注册获得了积分。
