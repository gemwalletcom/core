...
notification_reward_create_username_description = आपका यूज़रनेम तैयार है। अपने पुरस्कार बढ़ाने के लिए दोस्तों को आमंत्रित करें।
notification_reward_invite_description = आपका रेफरल सफल रहा! आपके कोड का उपयोग करके एक मित्र ने सदस्यता ली।
notification_rewards_joined_description = रेफरल कोड के साथ जुड़ने पर आपको अंक मिले।
