...
pub fn map_stellar_asset_to_asset(asset: &StellarAsset, token_id: String, chain: Chain) -> Asset {
    Asset {
...
mod tests {
    ...
    #[test]
    fn test_map_stellar_asset_to_asset() {
        ...
        let result = map_stellar_asset_to_asset(&stellar_asset, token_id, chain);
