...
use crate::{models::{Subscription, SubscriptionAddressExclude}, DatabaseClient};
...
pub trait SubscriptionsRepository {
    ...
    fn get_subscriptions_with_device_info(&mut self, chain: Chain, addresses: Vec<String>) -> Result<Vec<Subscription>, Box<dyn Error + Send + Sync>>;
