...
pub(crate) trait LinkTypesStore {
    fn add_link_types(&mut self, values: Vec<LinkTypeRow>) -> Result<usize, diesel::result::Error>;
}
...
impl DatabaseClient {
    pub fn add_link_types(&mut self, values: Vec<LinkTypeRow>) -> Result<usize, diesel::result::Error> {
