...
mod tests {
  ...
  "locale": "en"
    ...
    #[test]
    fn test_generate_rsa_pss_signature_pem_wrapped_private_key() {
        let base64_private_key = "";

        let der = general_purpose::STANDARD.decode(base64_private_key).expect("DER decode failed");
        let pem_body = general_purpose::STANDARD.encode(der);
        let pem_body_wrapped = pem_body
            .as_bytes()
            .chunks(64)
            .map(|chunk| std::str::from_utf8(chunk).expect("valid base64 chunk"))
            .collect::<Vec<_>>()
            .join("\n");
        let pem = format!("-----BEGIN PRIVATE KEY-----\n{pem_body_wrapped}\n-----END PRIVATE KEY-----\n");
        let base64_pem = general_purpose::STANDARD.encode(pem);

        let request_body = r#"{"test":"data"}"#;
        let signature = generate_rsa_pss_signature(&base64_pem, request_body).expect("Failed to generate signature from PEM");
