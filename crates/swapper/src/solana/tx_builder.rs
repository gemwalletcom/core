...
use solana_primitives::{TransactionBuilder, types::{Instruction, Pubkey}};
use std::sync::Arc;

pub async fn build_base64_transaction(
    fee_payer: Pubkey,
    ...
    let blockhash_array: [u8; 32] = blockhash
        .try_into()
        .map_err(|_| "Failed to convert blockhash to array".to_string())?;
