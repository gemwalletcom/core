...
use crate::{
    FetchQuoteData, ProviderData, ProviderType, Quote, QuoteRequest, Route, Swapper, SwapperChainAsset, SwapperError, SwapperMode, SwapperProvider,
    SwapperQuoteData, alien::RpcClient, slippage::apply_slippage_in_bp,
};
use gem_client::Client;
use gem_sui::{
    EMPTY_ADDRESS, SUI_COIN_TYPE_FULL, SuiClient,
...
mod tests {
    ...
    use gem_sui::{
        gas_budget::GasBudgetCalculator,
        models::{CoinAsset, InspectGasUsed},
    ...
    fn test_build_swap_transaction() {
        ...
        let expected_kind = "";
        ...
        let tx_output = TxOutput::from_tx(&tx).unwrap();
        let expected_tx = "";
        ...
        assert_eq!(hex::encode(tx_output.hash), "bb64f2086d75e71c94347bc86ef2350c40fda08746f52c0d6fd15d4bc5f8247d");
    }
