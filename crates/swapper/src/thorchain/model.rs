...
mod tests {
    use super::*;
    use primitives::asset_constants::{USDT_ETH_ASSET_ID, USDT_TRON_ASSET_ID};
    ...
    fn test_resolve_asset_id() {
        ...
        assert_eq!(
            ...
            Some(USDT_ETH_ASSET_ID.into())
        );
        assert_eq!(coin("TRON.USDT-TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t").resolve_asset_id(), Some(USDT_TRON_ASSET_ID.into()));
