...
fn spot_send_typed_data(spot_send: actions::SpotSend) -> String {
...
fn usd_class_transfer_typed_data(usd_class_transfer: actions::UsdClassTransfer) -> String {
...
// L1 payload
pub fn place_order_typed_data(order: actions::PlaceOrder, nonce: u64) -> String {
    let action_value = serde_json::to_value(&order).unwrap();
    l1_action_typed_data(action_value, nonce)
}

// L1 payload
pub fn set_referrer_typed_data(referrer: actions::SetReferrer, nonce: u64) -> String {
    let action_value = serde_json::to_value(&referrer).unwrap();
    l1_action_typed_data(action_value, nonce)
}

// L1 payload
pub fn update_leverage_typed_data(update_leverage: actions::UpdateLeverage, nonce: u64) -> String {
    let action_value = serde_json::to_value(&update_leverage).unwrap();
    l1_action_typed_data(action_value, nonce)
}

// User signed payload
pub fn withdrawal_request_typed_data(request: actions::WithdrawalRequest) -> String {
...
// User signed payload
pub fn approve_agent_typed_data(agent: actions::ApproveAgent) -> String {
...
// User signed payload
pub fn approve_builder_fee_typed_data(fee: actions::ApproveBuilderFee) -> String {
...
pub fn transfer_to_hyper_evm_typed_data(spot_send: actions::SpotSend) -> String {
    spot_send_typed_data(spot_send)
}

pub fn send_spot_token_to_address_typed_data(spot_send: actions::SpotSend) -> String {
    spot_send_typed_data(spot_send)
}

pub fn send_perps_usd_to_address_typed_data(usd_send: actions::UsdSend) -> String {
...
pub fn transfer_spot_to_perps_typed_data(usd_class_transfer: actions::UsdClassTransfer) -> String {
    usd_class_transfer_typed_data(usd_class_transfer)
}

pub fn transfer_perps_to_spot_typed_data(usd_class_transfer: actions::UsdClassTransfer) -> String {
    usd_class_transfer_typed_data(usd_class_transfer)
}

// User signed payload
pub fn c_deposit_typed_data(c_deposit: actions::CDeposit) -> String {
...
// User signed payload
pub fn token_delegate_typed_data(token_delegate: actions::TokenDelegate) -> String {
...
mod tests {
    ...
    fn test_eip712_approve_agent() {
        let agent = actions::ApproveAgent::new("0xbec81216a5edeaed508709d8526078c750e307ad".to_string(), "".to_string(), 1753576844319);
    ...
    fn test_eip712_withdrawal() {
        let withdrawal = actions::WithdrawalRequest::new("2".to_string(), 1753577591421, "0x514bcb1f9aabb904e6106bd1052b66d2706dbbb7".to_string());
    ...
    fn test_l1_action_hash() {
        ...
        use actions::{Grouping, LimitOrder, Order, OrderType, PlaceOrder, TimeInForce};
    ...
    fn test_address_lowercasing_in_actions() {
        ...
        let withdrawal = actions::WithdrawalRequest::new("2".to_string(), 1753577591421, uppercase_address.to_string());
        assert_eq!(withdrawal.destination, expected_lowercase);

        // Test approve agent
        let agent = actions::ApproveAgent::new(uppercase_address.to_string(), "test".to_string(), 1753576844319);
        assert_eq!(agent.agent_address, expected_lowercase);

        // Test approve builder fee
        let fee = actions::ApproveBuilderFee::new("0.001".to_string(), uppercase_address.to_string(), 1753576844319);
    ...
    fn test_update_leverage_typed_data() {
        let update_leverage = actions::UpdateLeverage::new(25, true, 10);
        ...
        let action_value = serde_json::to_value(actions::UpdateLeverage::new(25, true, 10)).unwrap();
    ...
    fn test_eip712_spot_send_core_to_evm() {
        let spot_send = actions::SpotSend::new(
            "0.1".to_string(),
    ...
    fn test_eip712_usd_send() {
        let usd_send = actions::UsdSend::new("1".to_string(), "0xe51d0862078098c84346b6203b50b996f7dafe28".to_string(), 1754987223323);
    ...
    fn test_eip712_usd_class_transfer_perp_to_spot() {
        let usd_class_transfer = actions::UsdClassTransfer::new(
            "10".to_string(),
            false, // perp to spot
            1754986301493,
        );
    ...
    fn test_eip712_c_deposit() {
        let c_deposit = actions::CDeposit::new(10000000, 1755231476741);
    ...
    fn test_eip712_token_delegate() {
        let token_delegate = actions::TokenDelegate::new("0x5ac99df645f3414876c816caa18b2d234024b487".to_string(), 10000000, false, 1755231522831);
