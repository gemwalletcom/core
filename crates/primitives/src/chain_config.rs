use crate::asset_constants::{
    WETH_ARB_CONTRACT, WETH_BASE_CONTRACT, WETH_BLAST_CONTRACT, WETH_ETH_CONTRACT, WETH_INK_CONTRACT, WETH_LINEA_CONTRACT, WETH_OP_CONTRACT,
    WETH_OPSTACK_CONTRACT, WETH_UNICHAIN_CONTRACT, WETH_WORLD_CONTRACT, WETH_ZKSYNC_CONTRACT,
};
