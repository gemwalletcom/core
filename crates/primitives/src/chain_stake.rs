...
impl StakeChain {
    ...
    pub fn get_min_stake_amount(&self) -> u64 {
        match self {
            ...
            Self::Monad => 100_000_000_000_000_000,        // 0.1 MON
    ...
    pub fn get_change_amount_on_unstake(&self) -> bool {
        match self {
            ...
            | Self::HyperCore
            | Self::Monad => true,
            Self::Sui | Self::Solana | Self::Aptos => false,
        }
    }
    ...
    pub fn get_can_redelegate(&self) -> bool {
        match self {
            ...
            Self::Ethereum | Self::Sui | Self::Solana | Self::Aptos | Self::HyperCore | Self::Monad => false,
        }
    }

    pub fn get_can_withdraw(&self) -> bool {
        match self {
            Self::Ethereum | Self::Solana | Self::Tron | Self::SmartChain | Self::Aptos | Self::Monad => true,
    ...
    pub fn get_can_claim_rewards(&self) -> bool {
        match self {
            Self::Cosmos | Self::Osmosis | Self::Injective | Self::Sei | Self::Celestia | Self::Tron | Self::Monad => true,
    ...
    pub fn get_reserved_for_fees(&self) -> u64 {
        match self {
            ...
            Self::Monad => 50_000_000_000_000_000,     // 0.5 MON
