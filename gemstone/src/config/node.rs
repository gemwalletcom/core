...
pub fn get_nodes_for_chain(chain: Chain) -> Vec<Node> {
    match chain {
        ...
        Chain::Solana => vec![
            ...
            Node::new("https://api.mainnet-beta.solana.com", NodePriority::High),
        ],
        Chain::Polygon => vec![
        ...
        Chain::Celestia => vec![Node::new(
            "https://celestia-rest.publicnode.com",
            NodePriority::High,
        )],
        Chain::Injective => vec![Node::new(
        ...
        Chain::Blast => vec![Node::new(
            "https://rpc.blastblockchain.com",
            NodePriority::High,
        )],
        Chain::Noble => vec![Node::new(
