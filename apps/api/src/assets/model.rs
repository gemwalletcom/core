...
mod tests {
    ...
    #[test]
    fn rank_threshold() {
        assert_eq!(SearchRequest::new("BTC".to_string(), None, None, None, None).rank_threshold(), 15);
        assert_eq!(SearchRequest::new("USDT".to_string(), None, None, None, None).rank_threshold(), 15);
        assert_eq!(SearchRequest::new("ethereum".to_string(), None, None, None, None).rank_threshold(), 5);
    }
    ...
    fn new() {
        let request = SearchRequest::new(
            "test".to_string(),
            Some("ethereum,bitcoin".to_string()),
            Some("defi,nft".to_string()),
            Some(100),
            Some(10),
        );
        ...
        let default_request = SearchRequest::new("query".to_string(), None, None, None, None);
